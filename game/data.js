(function () {
  ...
  const INTIMACY = {
    ...
    party: {
      ...
      condom: { dc: 11, lines: ["You've got one on you and she watches you produce it and the held breath goes out of her all at once — that specific ease that only comes from not having had to ask. After that there is nothing careful left in any of it. The bassline comes through the wall and the door takes most of your weight and she's got a fistful of your shirt and her mouth at your ear telling you exactly what she wants, and the party stops existing for as long as you let it. It goes on a while. Neither of you is in a hurry to be anywhere this isn't."], fx: { rom: 14, lib: 14, inti: 4, kiss: true }, failLines: ["She slows, both hands flat on your chest — not pushing, just pausing. \"…wait. I thought I was — \" A breath. \"I'm sorry. I'm not quite there.\" She doesn't move away; her forehead drops to your jaw and stays. The door's still shut. It's not an ending, just a stop, and she makes sure you know the difference.", "She catches your hands and holds them still, searching your face for a second. \"…I want to. I just — not tonight. I'm sorry.\" It's kind and it stings equally, and you both stand in the dark breathing it down until the feeling changes shape into something easier to carry back out there."] },
      raw: { dc: 16, lines: ["Neither of you reaches for anything, and the look you trade about that is its own short conversation, asked and answered in about a second. After that it's skin and the wall and her breath going uneven against your throat and the muffled thud of a party that has nothing to do with this room. She doesn't keep quiet. She doesn't try to. By the end she's boneless against you in the dark, mouth still at your jaw, in no state and no hurry to go back out there."], fx: { rom: 16, lib: 16, inti: 5, kiss: true }, failLines: ["She puts a hand flat on your chest, easy but certain. \"…not like that. Not without.\" You ease back; the door stays shut; the party is still there on the other side of it. The moment is warm enough, and some lines she just keeps."] },
