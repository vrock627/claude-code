      ...
      { key: "view", name: "The overlook", enter: "You both get out into the cold clean air. The city does that thing where it stops being traffic and becomes a circuit board. {n} leans on the rail like she could watch it all night.",
        actions: [
          ...
          { label: "Take a picture", enter: "\"Okay, this we are documenting,\" she says, digging your phone out of your own pocket like she lives there.", sub: [
            ...
            { label: "Make it a real shoot — you direct", enter: "She hands you the phone and steps into the headlight wash, mock-serious. \"Fine. Direct me. Be gentle, I'm an artist.\" It's going to take a while and you both clearly want it to. Try as many directions as you like — push it on when you want it to go further.", sub: [
              ...
              { label: "Push it further → lose the jacket", gate: { inti: 3, rom: 30 }, roll: { dc: 13, win: { fx: { rom: 9, lib: 8, inti: 3 }, lines: ["You ask for the jacket like a joke and she gives the first one as a joke — then drops it off both shoulders on the next, slow, not joking at all, watching you watch the little screen. The temperature of the whole evening moves ten degrees and you both feel exactly when."] }, lose: { fx: { rom: -3, aff: -2 }, lines: ["\"It is genuinely freezing, maniac.\" Jacket stays. The air resets, no harm. Try another direction."] } }, sub: [
                { label: "\"Arch your back, chin down\"", roll: { dc: 12, win: { fx: { rom: 9, lib: 7, inti: 2 }, lines: ["She finds the line of it and holds it, and the cold has stopped being why she's doing this slowly. Several frames. None of them are leaving the phone and you both know it now."] }, lose: { fx: { rom: 2, aff: 1 }, lines: ["\"That's a gym-selfie pose and I won't.\" She refuses on principle, grinning. Try again."] } } },
                { label: "\"Strap off the shoulder — just that\"", roll: { dc: 13, win: { fx: { rom: 10, lib: 9, inti: 3 }, lines: ["One strap, slow, with her eyes on you the whole way down it instead of the lens. It's still technically a shoot. It is unmistakably not only a shoot, and she's the one who decided that."] }, lose: { fx: { rom: -2, aff: -1 }, lines: ["She thumbs the strap back up, smirking. \"Earn it.\" The moment waits, patient."] } } },
                { label: "Further → the top comes off", gate: { inti: 4, rom: 38 }, roll: { dc: 14, win: { fx: { rom: 11, lib: 11, inti: 4 }, lines: ["She crosses her arms, takes the hem, and draws it up slow with the city burning behind her — watching your face do whatever it does, daring you to make it weird. You don't. You just keep shooting, because she told you to, and because you could not stop."] }, lose: { fx: { rom: -4, aff: -3 }, lines: ["\"Slower than that.\" Top stays. Not a no — a pace. Run another frame first."] } }, sub: [
                  { label: "\"Hands on the hood, look back at me\"", roll: { dc: 13, win: { fx: { rom: 11, lib: 11, inti: 3 }, lines: ["She braces on the warm metal and turns just her head, and the look down the lens is not a look you photograph and post, it's one you keep, and she knows precisely which kind she just gave you."] }, lose: { fx: { rom: -2, aff: -1 }, lines: ["\"Cold metal! Cold!\" She breaks the pose laughing. Reset, no damage."] } } },
                  { label: "\"Now the bra — only if you want\"", gate: { inti: 5, rom: 45 }, roll: { dc: 15, win: { fx: { rom: 12, lib: 13, inti: 4, kiss: true }, lines: ["One hand, the clasp, the slow breath out of her as it goes — and she lets you get exactly that, unhurried, the phone steady because you're making it be. She does not reach to cover anything. She watches you not be able to look away and looks extremely pleased about it."] }, lose: { fx: { rom: -5, aff: -3 }, lines: ["\"That one I keep for now.\" Firm about the clasp, pointedly not about the night. Another frame, then."] } }, sub: [
                    { label: "\"Skirt next — turn for me\"", gate: { inti: 6, rom: 50 }, roll: { dc: 15, win: { fx: { rom: 13, lib: 14, inti: 4 }, lines: ["Button, slide, the long unhurried drag of it down with her watching you over her shoulder the whole way. She steps out of it like the shoot was always heading exactly here, because by now it obviously was."] }, lose: { fx: { rom: -5, aff: -3 }, lines: ["She catches your eye and shakes her head once, smiling. Not yet. Keep shooting up here."] } }, sub: [
                      { label: "\"Last of it. All of it. Just for us.\"", gate: { inti: 7, rom: 55 }, roll: { dc: 16, win: { fx: { rom: 15, lib: 16, inti: 5, kiss: true, attire: "bare" }, lines: ["She holds your eyes, never the lens, and takes the last of it off like the dare had been hers from the first frame, and lets you take exactly one photo that is never touching a cloud as long as you both live. Then she's done being the subject — nothing at all between the camera and her now, and entirely unbothered about it."] }, lose: { fx: { rom: -6, aff: -4 }, lines: ["\"Mm — no. That one stays in my head, not your phone.\" A line, calmly kept. You put the phone down and mean it; she watches you mean it."] } }, sub: [
                        { label: "Keep shooting her exactly like this", roll: { dc: 14, win: { fx: { rom: 12, lib: 15, inti: 4 }, lines: ["She lets you, and runs it — owning every frame, no longer pretending the directing was ever yours, the cold and the city and her and a phone that has stopped being the point of anything."] }, lose: { fx: { rom: 4, aff: 2 }, lines: ["\"Okay — your turn now. Fair's extremely fair.\" She holds her hand out for the phone."] } } },
                        { label: "\"…okay. Now hand me the camera.\" (she turns it on you)", enter: "She slides the phone out of your fingers with a slow, ruinous grin and turns it around on you. \"Fair's fair. Your turn. Same rule — only what you want to.\" She's already finding your light, merciless.", sub: [
                          { label: "Let it all hang out", roll: { dc: 11, win: { fx: { rom: 11, lib: 14, inti: 4 }, lines: ["You give her exactly what she gave you — all of it, zero flinch — and she goes very quiet behind the phone, which from her is the entire review. \"…huh,\" she says, evenly, and does not stop at one. She has some of you now, and she knows it, and she likes it."] }, lose: { fx: { rom: 4, aff: 3 }, lines: ["You overdo it into a pratfall and she howls and gets that instead. Honestly a better photo. She still got one of you."] } }, sub: [
                            { label: "\"Now both of us.\" (together, on the record)", gate: { inti: 8, rom: 58 }, roll: { dc: 15, win: { sex: "shoot" }, lose: { fx: { rom: -3, aff: -2 }, lines: ["You reach to pull her into frame; she lets the phone drop to the seat instead. \"Forget the picture for a second.\" Not a no. The exact opposite. Just not yet, not through a lens."] } } },
                            ...
                            { label: "Phone away — just her now, none of it kept", fx: { rom: 9, aff: 8, inti: 3 }, lines: ["You take the phone out of her hand and set it screen-down on the hood and that's the end of the documentary. Whatever happens next, nobody will ever be able to prove it — which is, she's said, exactly how she keeps the best ones."], sub: [
                              ...
                              { label: "Just her, just this, nothing else", fx: { rom: 10, aff: 9, inti: 3 }, lines: ["You don't take it anywhere. Just her, against the warm metal, the whole city indifferent below, and choosing to stop here is somehow the loudest thing all night."] },
                              { label: "Back up", back: true },
                            ] },
                            { label: "Back up", back: true },
                          ] },
                          { label: "Cover up — make her work for it", roll: { dc: 12, win: { fx: { rom: 9, lib: 9, inti: 3 }, lines: ["You play coy and she gets competitive, directing you exactly the way you directed her, merciless and laughing, until she lands the frame she was after and looks insufferably pleased. She got some of you. The scoreboard is, she announces, even."] }, lose: { fx: { rom: 4, aff: 3 }, lines: ["She can't get the angle and gives up cackling. \"Useless. Gorgeous, but useless.\" Try letting her actually get one."] } }, sub: [
                            ...
                            { label: "Phone away — just her now, none of it kept", fx: { rom: 9, aff: 8, inti: 3 }, lines: ["You set the phone face-down on the hood and the shoot's over. Whatever's next leaves no proof, exactly how she likes the best ones."], sub: [
                          ...
                          { label: "Refuse — it's a one-way camera", fx: { rom: 3, aff: 4 }, lines: ["\"Absolutely not.\" She mock-gasps at the hypocrisy, lobs your jacket at your head, and keeps the photos she already has — the only leverage in this car that matters, she points out, very smug, fully clothed in your jacket now and not giving the phone back."] },
                          { label: "Back up", back: true },
                        ] },
