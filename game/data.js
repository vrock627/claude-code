      ...
      { key: "view", name: "The overlook", enter: "You both get out into the cold clean air. The city does that thing where it stops being traffic and becomes a circuit board. {n} leans on the rail like she could watch it all night.",
        actions: [
          ...
          { label: "Take a picture", enter: "\"Okay, this we are documenting,\" she says, digging your phone out of your own pocket like she lives there.", sub: [
            ...
            { label: "Make it a real shoot — you direct", enter: "She hands you the phone and steps back into the headlight wash, mock-serious. \"Fine. Direct me. Be gentle, I'm an artist.\" It is very obviously going to take a while, and neither of you minds that at all.", sub: [
              { label: "\"Make a silly face\"", fx: { rom: 5, aff: 7, inti: 1 }, lines: ["She gives you something cross-eyed and feral and perfect and you take nine of them. The warm-up does more than it looks like — somewhere in the bad ones she stops performing for a camera and starts trusting the person holding it. You."] },
              { label: "\"Whatever you're comfortable with — just move\"", roll: { dc: 11, win: { fx: { rom: 8, aff: 8, inti: 2 }, lines: ["You quit posing her and just let her drift, and she does — finds her own angles, laughs at herself, keeps glancing back to check you're still watching. You are. She clocks that you are. That look, caught mid-turn, is the whole shoot and you both know it."] }, lose: { fx: { rom: 2, aff: 2 }, lines: ["She seizes up, too aware of the lens. \"I'm so bad at this part.\" You lower the phone and let her shake it off before you try again."] } }, sub: [
                { label: "\"Now look back over your shoulder\"", roll: { dc: 12, win: { fx: { rom: 9, lib: 5, inti: 2 }, lines: ["Chin to her shoulder, eyes coming back down the lens, the city going soft and gold behind her. She holds it a half-beat too long, and the half-beat is the photograph, and neither of you says one word about the half-beat."] }, lose: { fx: { rom: 3, aff: 2 }, lines: ["She overthinks it into something stiff and you both crack up at it. \"Delete. Go again.\" You go again. You'd go all night."] } }, sub: [
                  { label: "\"Try sticking your chest out a little\"", gate: { inti: 3, rom: 30 }, roll: { dc: 13, win: { fx: { rom: 9, lib: 8, inti: 3 }, lines: ["You pitch it as a joke to take the edge off and she does the first one as a joke right back — overdone, laughing. Then she does the next one not even slightly as a joke, holding your eyes over the top of the phone, and the temperature of the entire evening moves about ten degrees and you both feel exactly when it does."] }, lose: { fx: { rom: -3, aff: -2 }, lines: ["\"Real subtle.\" She stays exactly as she was, eyebrow up. You back the lens off and the air resets, no harm done."] } }, sub: [
                    { label: "\"Lose the jacket — only the jacket\"", gate: { inti: 4, rom: 36 }, roll: { dc: 14, win: { fx: { rom: 10, lib: 9, inti: 3 }, lines: ["Off one shoulder, then the other, slower than the cold remotely requires, her watching you watch the little screen the whole way down. It is still, technically, a photoshoot. It is also, now, unmistakably not only a photoshoot, and she's the one who decided that."] }, lose: { fx: { rom: -3, aff: -2 }, lines: ["\"It is genuinely freezing, you maniac.\" She keeps it on, grinning, and the moment just waits, patient and unbothered."] } }, sub: [
                      { label: "\"More — only what you actually want to\"", gate: { inti: 5, rom: 44 }, roll: { dc: 14, win: { fx: { rom: 12, lib: 12, inti: 4, kiss: true }, lines: ["She takes it exactly as far as she decides to, one unhurried layer at a time, fully in command of every inch of it while letting you keep believing you're the one directing. By the time she's down to almost nothing the phone has become mostly a formality and you have both noticed and neither of you calls it yet."] }, lose: { fx: { rom: -5, aff: -3 }, lines: ["\"That's the line for the camera tonight.\" Firm and final about the camera — pointedly not about the night. She resettles her jacket; the shoot's done, the evening very much isn't."] } }, sub: [
                        { label: "\"Last one. All of it. Just for us.\"", gate: { inti: 7, rom: 54 }, roll: { dc: 15, win: { fx: { rom: 14, lib: 16, inti: 5, kiss: true, attire: "bare" }, lines: ["She holds your eyes the whole time, never the lens, and takes the last of it off like the dare had been hers from the start, and lets you take precisely one frame that is never touching a cloud. Then she's done being the subject and crosses the small cold dark to you, entirely unbothered that there's nothing at all between the camera and her anymore."] }, lose: { fx: { rom: -6, aff: -4 }, lines: ["\"Mm — no. That one stays in my head, not your phone.\" Not anger. A line, calmly kept. You put the phone away and you mean it, and she watches you mean it."] } }, sub: [
                          { label: "\"…okay. Now hand me the camera.\" (she turns it on you)", enter: "She slides the phone out of your fingers with a slow, very pleased grin and turns it around on you. \"Fair's fair. Your turn. Same rule — only what you want to.\" She's already finding the light on you, ruthless as ever.", sub: [
                            { label: "Let it all hang out", fx: { rom: 10, lib: 13, inti: 4 }, lines: ["You give her precisely what she gave you — all of it, zero flinch — and she goes quiet behind the phone in a way that is its own entire review. \"…huh,\" she says, very evenly, and does not stop at one."] },
                            { label: "Cover up — make her work for it", roll: { dc: 12, win: { fx: { rom: 9, lib: 9, inti: 3 }, lines: ["You play it coy and she gets competitive about it, directing you exactly the way you directed her, merciless and laughing, until she lands the frame she was after and looks insufferably pleased with herself about it."] }, lose: { fx: { rom: 4, aff: 3 }, lines: ["She can't get the angle she wants and gives up cackling. \"Useless. Gorgeous, but useless.\" You'll take that."] } } },
                            { label: "Refuse — it's a one-way camera", fx: { rom: 3, aff: 4 }, lines: ["\"Absolutely not.\" She mock-gasps at the rank hypocrisy, lobs your own jacket at your head, and keeps the photos she already has — which, she points out smugly, is the only leverage in this car that matters."] },
                            { label: "\"Get in here. Both of us.\" (something suggestive, together)", gate: { inti: 8, rom: 58 }, roll: { dc: 15, win: { sex: true }, lose: { fx: { rom: -4, aff: -3 }, lines: ["You reach to pull her into frame and she lets the phone drop to the seat instead. \"Forget the picture.\" Not a no. The exact opposite of one. Just not through a lens."] } } },
                            { label: "Leave the photos — just be here", fx: { rom: 9, aff: 8, inti: 2 }, lines: ["You both set the phone face-down on the hood and stop documenting any of it. Whatever the rest of tonight is, nobody will ever be able to prove it, which is precisely how she wants the best ones kept."] },
                            { label: "Back up", back: true },
                          ] },
                          { label: "Back up", back: true },
                        ] },
                        { label: "Phone down — kiss her instead, no camera", fx: { rom: 9, lib: 7, inti: 3 }, lines: ["You set the phone face-first on the hood and close the gap instead. She makes a small, approving sound against your mouth like that was the correct read of the room, which it was."] },
                        { label: "Back up", back: true },
                      ] },
                      { label: "Back up", back: true },
                    ] },
